...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                <h3>2
                    <?php //echo app\models\Transaction::find()->count();?>
                </h3>
                <p>
                    Transactions
                </p>
            ...
            <a class="small-box-footer" href="<?php echo Yii::$app->urlManager->createUrl('transaction/index'); ?>">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            <div class="inner">
                <h3>3
                    <?php // echo app\models\Royalty::find()->count();?>
                </h3>
                <p>
                    Royalty
                </p>
...
<div class="row">
    ...
    <section class="col-lg-9 connectedSortable ui-sortable">                                    
        ...
        <?php echo \sintret\chat\ChatRoom::widget([
            'url' => Url::to(['/ajax/send-chat']),
            'userModel'=> \common\models\User::className(),
            'userField' => 'avatarImage'
                ]); ?>
        <!-- To Do List -->        
        <?php echo  \sintret\todolist\ListView::widget([
            'url' => Url::to(['/ajax/todolist'])
        ]);
        ?>
