    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <a href="<?php echo Yii::$app->urlManager->createUrl('site/forgot_password');?>" class="pull-right need-help">Forgot Password </a><span class="clearfix"></span>
                <?php ActiveForm::end(); ?>
            </div>
            <a href="<?php echo Yii::$app->urlManager->createUrl('site/signup');?>" class="text-center new-account">Create an account </a>
        </div>
    </div>
</div>