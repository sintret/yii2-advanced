...
class SettingSearch extends Setting
{
    ...
    public function rules()
    {
        return [
            ...
            [['emailAdmin', 'emailSupport', 'emailOrder', 'sendgridUsername', 'sendgridPassword', 'whatsappNumber', 'whatsappPassword', 'whatsappSend', 'facebook', 'instagram', 'google', 'twitter', 'privacyPolicy', 'terms', 'legalNotice', 'createDate', 'updateDate'], 'safe'],
        ];
    }
